...
- Add an Environment Variable. Set the name to JUPITER_ENGINE_DIR, and the value to the path to Jupiter Engine's Root. Note it should end with '\\'. Example: C:\Program Files\Jupiter Technologies\Jupiter-Engine\
