...
export namespace jpt
{
    ...
    /** A geometric tolerance, not machine epsilon. Loose enough that a normalize guard rejects
        denormals rather than producing inf, which an exact `!= 0` test lets through. */
