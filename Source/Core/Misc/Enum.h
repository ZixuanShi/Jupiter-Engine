...
namespace jpt
{
	...
	JPT_API EnumSearchInfo BuildEnumStringInfos(const char* rawEnumString, EnumStringInfo* infos, int32 start, size_t count);
	...
	JPT_API jpt::string GetSubString(int32 value, const EnumSearchInfo& searchInfo);
	JPT_API jpt::string_view GetSubStringView(int32 value, const EnumSearchInfo& searchInfo);
