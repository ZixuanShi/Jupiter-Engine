...
namespace jpt::Vulkan
{
	bool GraphicsPipeline::Init()
	{
		...
		VkPipelineShaderStageCreateInfo vertexShaderStageInfo = vertexShader.Load("_Baked/Jupiter_Common/Shaders/sample.vs.spv");
		VkPipelineShaderStageCreateInfo pixelShaderStageInfo = pixelShader.Load("_Baked/Jupiter_Common/Shaders/sample.ps.spv");
