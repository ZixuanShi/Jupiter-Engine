...
{
    bool RenderPass::Init(VkFormat imageFormat)
    {
        ...
        depthAttachment.format = PhysicalDevice::Get().FindDepthFormat();
        ...
        if (const VkResult result = vkCreateRenderPass(LogicalDevice::GetVkDevice(), &renderPassInfo, nullptr, &m_renderPass); result != VK_SUCCESS)
        {
