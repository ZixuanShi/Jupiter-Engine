...
namespace jpt::Vulkan
{
	...
	bool Texture_Vulkan::CreateImage(const File::Path& fullPath)
	{
		...
		jpt::Vulkan::CreateImage(texWidth, texHeight, m_mipLevels,
			VK_SAMPLE_COUNT_1_BIT, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT,
