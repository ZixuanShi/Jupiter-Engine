...
static_assert(std::size(kKeyNames) == static_cast<usize>(jpt::KeyCode::Count), "KeyCode names are out of sync with the enum");
...
static_assert(std::size(kMouseButtonNames) == static_cast<usize>(jpt::MouseButton::Count), "MouseButton names are out of sync with the enum");