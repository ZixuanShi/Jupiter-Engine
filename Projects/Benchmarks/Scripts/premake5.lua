...
workspace "JupiterBenchmarks"
    ...
    local project_dir = "C:/Program Files/Jupiter Technologies/Jupiter-Engine/Projects/Benchmarks/"   -- Needs to be changed if the Game Project moves.-- Config
