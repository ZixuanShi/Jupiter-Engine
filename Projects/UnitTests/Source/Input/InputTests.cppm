...
{
    /** Driven by ApplicationUnitTests::PreInit, after Input is up and before a window exists.
        Synthetic key and mouse events need assistive access, so everything below the OS is
