...
using TestDispatcher = jpt::EventDispatcher<TestEvent>;
...
export void RunUnitTests_EventDispatcherRegistration(jpt::TestCase& test)
{
    ...
    test.Expect(first != jpt::kInvalid<TestDispatcher::Handle>, "Add returned the invalid handle");
...
export void RunUnitTests_EventDispatcherMemberBinding(jpt::TestCase& test)
{
    TestDispatcher dispatcher;
...
export void RunUnitTests_EventDispatcherReentrancy(jpt::TestCase& test)
{
    {
        TestDispatcher dispatcher;
        ...
        int32 selfCount = 0;
        TestDispatcher::Handle self = jpt::kInvalid<TestDispatcher::Handle>;
